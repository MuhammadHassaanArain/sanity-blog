...
function Testimonials() {
  ...
  <div className="container px-5 py-14 mx-auto">
    <h1 className="text-3xl font-medium title-font text-gray-900 mb-1 text-center">Testimonials</h1>
    <div className="h-1 w-20 bg-indigo-500 rounded text-center mx-auto mb-12" ></div>
